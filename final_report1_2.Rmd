...
```{r}
load("data_oos.Rdata")#you may need to change it to correct directory when you running it on your own
CPI<-c(cpi$CPI,real.X[,67][[1]])
PPI<-c(ppi$PPI,real.X[,72][[1]])
inf_cpi<-diff(CPI,12)
inf_ppi<-diff(PPI,12)
train_index<-1:156
...
CPI forecasting with differnt method
